	...
	<div class="main container">
		...
		<section class="product-box">
			...
			<div class="row">
				...
				<div class="col-xs-6 col-sm-4 col-md-3 col-lg-3" data-id="<?=$products['id']?>">
					<div class="product">
						<div class="product-pic" style="background: url('<?=$products['image']?>') no-repeat; background-size: auto 100%; background-position: center"></div>
						<span class="product-name"><?=$products['name']?></span>
						<span class="product_price"><?=$products['price']?></span>
